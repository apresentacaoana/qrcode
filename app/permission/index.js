    ...
    return (
        <SafeAreaView className="flex-1 bg-[#0d0d0d]">
            ...
            <View className="flex-1 m-7 items-center justify-center">
                <Text className="text-white mb-3 text-center text-[17px]">Para a aplicação funcionar é necessário que você permita o acesso a sua localização e câmera.</Text>
