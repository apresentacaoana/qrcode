...
const novoAlerta = async ({conteudo, titulo, dias}) => {
    try {
...
export {logout, entrarComGoogle, novoTermo, updateTermo, getTermo, getRequestById, novoAlerta, updateAlerta, excluirAlerta, getAlertas, getUserByCPF, excluirBonus, updateVenda, getPostoById, updatePosto, getVendas, getVendasByCompradorId, getAllBonus, novoBonus, getVendasById, getVendasByVendedorId, aceitarRequest, updatePlano, updateBonus, excluirRequest, getRequests, novoRequest, deleteBonus, excluirPlano, novoPlano, getPlanos, excluirPosto, getPostos, novoPosto, getBonusById, getUserById,  novaVenda, updateUser, getUserByEmail, loginComEmailESenha, recuperarSenha, registrarComEmailESenha}