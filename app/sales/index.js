        ...
        <SafeAreaView className="flex-1 bg-[#0d0d0d]">
            ...
            <View className="flex-1 m-7">
                    ...
                    <Widget className={"flex flex-col"}>
                        <Text className="text-orange-400">Você já vendeu</Text>
                        <View className="flex flex-row items-end -mt-1">
                            <Text className="text-orange-400 font-bold text-[42px]">R${sales.map(item => item.valor).reduce((acc, valor) => acc + valor, 0)}</Text>
                        </View>
                    </Widget>
